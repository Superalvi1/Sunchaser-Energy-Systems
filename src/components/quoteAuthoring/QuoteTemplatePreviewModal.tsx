      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 px-4 py-3 shrink-0">
          <div>
            ...
            <p className="text-[9px] text-slate-600 mt-0.5">Print Preview may vary. Download PDF uses server A4 engine.</p>
            {pdfActionStatus && (
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button type="button" onClick={printPreview} title="Browser print may vary. Use Download PDF for final client sharing." className="text-xs font-bold px-3 py-1.5 rounded-lg bg-slate-800 text-slate-200 hover:bg-slate-700 flex items-center gap-1">
