...
export default function ClientPortalService({ user }: ClientPortalServiceProps) {
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-xs text-slate-500 font-mono bg-slate-900/80 border border-slate-800 rounded-xl px-3 py-2">
        Full maintenance timeline, photos, and visit summary are in the{" "}
        <span className="text-amber-400 font-bold">Service History</span> tab.
      </p>
