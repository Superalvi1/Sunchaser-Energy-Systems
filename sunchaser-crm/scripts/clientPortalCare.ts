...
export const CARE_SERVICE_REQUEST_TYPES = [
  { key: "cleaning", label: "Cleaning Visit", serviceType: "Cleaning" },
  { key: "inspection", label: "Physical Inspection", serviceType: "Inspection" },
  { key: "battery", label: "Battery Health Check", serviceType: "Battery Health Check" },
] as const;
